...
public class NationInfoSub extends NationInfosSub {
	...
	public static String constructNationInfo(Nation nation) {
		...
		message += "  " + PlayerMessage.SUBHEADER.message("General") + "\n";
		message += "    " + PlayerMessage.LABEL_ARG.message("Claims", String.valueOf(nation.getArea())) + ":";
		message += PlayerMessage.LABEL_ARG.message("Perimeter", String.valueOf(nation.getPerimeter())) + "\n";
		message += "    " + PlayerMessage.LABEL_ARG.message("Balance", String.valueOf(nation.getBalance())) + "\n";
		message += "  " + PlayerMessage.SUBHEADER_VALUE.message("Members", nation.getMembers().size() + "") + "\n";
		message += "   " + NationMembersSub.constructMembersList(nation) + "\n";
		message += "  " + PlayerMessage.SUBHEADER_VALUE.message("Towns", nation.getTowns().size() + "") + "\n";
